...
contacts = pd.read_csv('data/contacts.csv', sep=',', encoding='utf-8', dtype={'customer_id': str})
customers = pd.read_csv('data/customers.csv', sep=',', encoding='utf-8', dtype={'customer_id': str})
orders = pd.read_csv('data/orders.csv', sep=',', encoding='utf-8', dtype={'customer_id': str})
